    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {/* Coming Soon: Video Calls */}
                <div className="bg-slate-50/50 p-8 rounded-3xl border border-slate-100/50 relative overflow-hidden group cursor-not-allowed">
                    <div className="absolute top-4 right-4 px-3 py-1 bg-slate-200 rounded-full text-[10px] font-bold uppercase tracking-widest text-slate-500">Coming Soon</div>
                    
                    <div className="w-16 h-16 rounded-2xl bg-slate-200 flex items-center justify-center text-slate-400 mb-8 opacity-50">
                        <Video className="w-8 h-8" />
                    </div>
                    
                    <h3 className="text-2xl font-bold text-slate-400 mb-3">Video Meet</h3>
                    <p className="text-slate-400/80 leading-relaxed">High-quality face-to-face video conferencing for formal team meetings and presentations.</p>
                </div>

                {/* Coming Soon: Team Chat */}
                <div className="bg-slate-50/50 p-8 rounded-3xl border border-slate-100/50 relative overflow-hidden group cursor-not-allowed">
                    <div className="absolute top-4 right-4 px-3 py-1 bg-slate-200 rounded-full text-[10px] font-bold uppercase tracking-widest text-slate-500">Coming Soon</div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-400 mb-3">Team Chat</h3>
                    <p className="text-slate-400/80 leading-relaxed">Persistent text channels and direct messaging for asynchronous team collaboration.</p>
                </div>
            </div>
