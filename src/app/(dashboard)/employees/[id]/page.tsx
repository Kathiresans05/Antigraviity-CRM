...
import {
    ...
    CheckCircle2, TrendingUp, XCircle, Timer, BarChart2, CalendarCheck
} from "lucide-react";
...
export default function EmployeeProfilePage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-12">
            ...
            {/* SECTION 4: PERFORMANCE STATS — visible to TL/Manager/HR/Admin */}
            {canViewStats && (
            ...
            <div className="space-y-4">
                {/* About Me Link Card */}
                <div onClick={() => router.push(`/employees/${id}/about`)} className="group bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-5 flex items-center justify-between cursor-pointer hover:shadow-md hover:border-blue-100 transition-all">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-gray-900 font-medium text-base sm:text-lg tracking-tight group-hover:text-blue-600 transition-colors">About Me</h3>
                            <p className="text-xs sm:text-sm text-gray-500 mt-0.5">View full personal, contact details, and approvers.</p>
                        </div>
                    </div>
                    <ChevronDown className="w-5 h-5 text-gray-400 group-hover:text-blue-500 transition-colors transform -rotate-90" />
                </div>

                {/* Address & Coordinates */}
                <details className="group bg-white rounded-xl shadow-sm border border-gray-100 [&_summary::-webkit-details-marker]:hidden">
                    <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer select-none hover:bg-gray-50/50 transition-colors">
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 bg-blue-50/80 text-blue-600 rounded-xl flex items-center justify-center border border-blue-100/50">
                                <MapPin className="w-5 h-5 stroke-[1.5]" />
                            </div>
                            <span className="text-gray-900 font-medium text-base sm:text-lg tracking-tight">Address & Coordinates</span>
                        </div>
                        <ChevronDown className="w-5 h-5 text-gray-400 group-open:text-blue-500 transition-all duration-300 transform group-open:rotate-180" />
                    </summary>
                    <div className="px-5 pb-5 border-t border-gray-50 pt-4 grid gap-4 text-sm">
                        <div>
                            <p className="text-gray-500 font-medium mb-1">Home Address</p>
                            <p className="text-gray-800">{basicDetails.address}</p>
                        </div>
                ...
                <details className="group bg-white rounded-xl shadow-sm border border-gray-100 [&_summary::-webkit-details-marker]:hidden">
                    <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer select-none hover:bg-gray-50/50 transition-colors">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-gray-900 font-medium text-base sm:text-lg tracking-tight">Family Details</span>
                        </div>
                        <ChevronDown className="w-5 h-5 text-gray-400 group-open:text-blue-500 transition-all duration-300 transform group-open:rotate-180" />
                    </summary>
                    <div className="px-5 pb-5 text-gray-600 text-sm leading-relaxed border-t border-gray-50 pt-4 whitespace-pre-line">
                        {basicDetails.familyDetails}
                    </div>
                </details>
            </div>
        </div>
