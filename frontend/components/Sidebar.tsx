...
const ADMIN_LINKS = [
    {
        ...
        items: [
            ...
            { name: "Shift Management", href: "/admin/attendance/shifts", icon: Clock },
            { name: "Attendance Policies", href: "/admin/attendance/policies", icon: ShieldCheck },
            { name: "Shift Assignments", href: "/admin/attendance/assignments", icon: UserPlus },
